  ...
  render() {
    return (
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <Post
          username="Г.Жаргал"
          title="Хэрхэн таргалах вэ?"
          postImg={require('../img/cover3.jpg')}
          proImg={require('../img/p5.png')}
          starCount={3}
          likeCount={247}
          isLiked={false}
        />
        <Post
          username="М.Ганбат"
          title="Төрсний дараах сэтгэл зүй"
          postImg={require('../img/cover2.jpg')}
          proImg={require('../img/p4.png')}
          starCount={4.5}
          likeCount={133}
          isLiked={true}
        />
        <Post
          username="М.Ганбат"
          title="Хэрхэн турах вэ?"
          postImg={require('../img/cover4.jpg')}
          proImg={require('../img/p3.png')}
          starCount={5}
          likeCount={44}
          isLiked={true}
        />
